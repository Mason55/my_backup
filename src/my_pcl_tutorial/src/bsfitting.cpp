...
void pca_init(const sensor_msgs::PointCloud2ConstPtr& cloud_msg, ON_NurbsSurface& nurbs)
{
  ...
  nurbs = pcl::on_nurbs::FittingSurface::initNurbsPCABoundingBox (order, &data);//这是原始的使用了boxing 的手段的;
...
main (int argc, char** argv)
{
  ...
  // ros::Subscriber sub2 = nh2.subscribe ("input", 1, pca_init);
